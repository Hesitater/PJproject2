...
<%
    ...
    String clientId = "E8BCZ8i4CQqEbjZzrLN1";
    String redirectURI = URLEncoder.encode("http://3.34.196.31/PJproject/naver/naverJoin", "UTF-8");
	...
	<div class="main_container main_page_default">
		<div class="join_main_box">
                <div class="join_main_wrapper">
                    ...
                    <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=d27f3e8d015a30e2ce5d28557f22b72a&redirect_uri=http://3.34.196.31/PJproject/kakao/kakaoJoin&prompt=login
                            " class="join_kakao">
